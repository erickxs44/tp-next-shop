      ...
      >
        ...
        <nav className="p-4 space-y-1">
          <Link
            to="/"
            onClick={() => setMenuOpen(false)}
            className="block w-full text-left px-4 py-3 font-display text-lg tracking-wider uppercase hover:bg-brand hover:text-brand-foreground transition border-l-2 border-transparent hover:border-brand"
          >
            Início
          </Link>
          {CATEGORIES.map((c) => (
